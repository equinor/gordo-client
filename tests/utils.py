...
class InfluxDB:
    ...
    def reset(self):
        ...
        dates = pd.date_range(start="2016-01-01", periods=2880, freq="min")  # Minute intervals for 2 days
...
def get_model(config):
    ...
    if Model is None:
        raise ValueError(f'Type of model: "{type}" either not provided or not supported')
    return Model(**config)
