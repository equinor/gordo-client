...
def ml_server(model_collection_directory, trained_model_directory, gordo_host, gordo_project):
    """
            ...
            if request.method in ("GET", "POST"):
                ...
                if request.body:
                    ...
                    if flask_request.json:
                        ...
                        kwargs["data"] = {k: (io.BytesIO(f.read()), f.filename) for k, f in flask_request.files.items()}
