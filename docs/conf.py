...
project = "gordo-client"
copyright = f"2020-{datetime.date.today().year}, Equinor"
author = "Equinor ASA"
version = get_version()
...
extlinks = {
    "issue": ("https://github.com/equinor/gordo-client/issues/%s", "Issue #"),
    "pr": ("https://github.com/equinor/gordo-client/pull/%s", "PR #"),
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/equinor/gordo-client",
